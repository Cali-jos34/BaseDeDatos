...
--Seleccionar el número de pedidos por cada empleado por el ultimo trimestre de 1996
select * from Orders
...
--seleccionar el numero de productos por categoria, pero solo aquellos que tengan más de 10 productos
...
--Listar las ordenes agrupadas por empleado, pero que solo muestre aquellos que hayan gestionado más de 10 pedidos
