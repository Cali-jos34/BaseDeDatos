...
--Ejecuci�n de un store con parametros de entrada
exec spu_InformeVentasClientes 'Berglunds snabbk�p', 
							   '1996-07-04', '1997-01-01';

--Ejecucion de un sp con parametros en diferente posici�n
exec spu_InformeVentasClientes @fechaFinal= '1997-01-01',
							   @nombre= 'Berglunds snabbk�p',
							   @fechaInicial= '1996-07-04'; 

--ejecuci�n de un sp con parametros de entrada con un campo que tiene un valor por default
...
--Crear un sp que permita verificar si un cliente existe antes de devolver su informaci�n (1 = el existente del primer dato)
...
exec spu_agregar_cliente_try_catch 'ALFKIC', 'Mu�eca'
